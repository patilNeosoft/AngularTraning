...
function ValidateForm(){
    ...
    if (email == ""||!regemail.test(email) ) {
        ...
        if(password !== cpassword){
            document.getElementById("cpassword").innerHTML="Please enter confirm password same as password"; 
        }
        else{
        ...
        if(remarks.length > 20){
            document.getElementById("remark").innerHTML="remark should be of maximum 20 characters.";
        }
        else{
